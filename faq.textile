...
Apart from the type of Slackware installation you're running, there's the issue of using external repositories. Starting with version 43 and inspired by community forks of @slackpkg@, @slackroll@ added support for external repositories, and performs a decent job at handling them.
