...
@installpkg@ for the first time. In the future, you can use @upgradepkg@ or
even @slackroll@ itself to upgrade to newer versions. Continue reading for more
details.
...
space available for them in there. Set the mirror URL with the @set-mirror@
...
the [[operations guide]]. This program is not a perfect tool. I think it can
handle almost every situation and be told to do exactly what you want, but
reading the change log and subscribing to the @slackware-security@ mailing list
...
comments or suggestions, "contact me":http://rg03.wordpress.com/contact-me/.
Keep in mind I'm using the program under @slackware-current@. If you detect a
problem under the stable version, please report it as soon as possible because
it may go unnoticed to me.
